...
class HierarchicalGraphResFPNOnlyPointDistance(nn.Module):
    def __init__(self, norm_layer=nn.BatchNorm2d, **cfg):
        super(HierarchicalGraphResFPNOnlyPointDistance, self).__init__()
        ...
        self.coord_embedding = nn.Embedding(self.num_joints, 2)
    ...
    def forward(self, x, labels=None):
        ...
        #    coords[:, i] = self.coord_embedding(i).unsqueeze(0).expand(BATCH_SIZE, -1, -1)  # [B, 2]
        #coords = coords.view(BATCH_SIZE, self.num_joints, 2)  # [B, num_joints, 2]
