...
class RLELossWithBasis_noBase(nn.Module):
    def __init__(self, size_average=True, **cfg):
        super(RLELossWithBasis_noBase, self).__init__()
    ...
    def forward(self, output, labels):
        ...
        if self.residual:
            ...
            loss = Q_logprob #nf_loss + Q_logprob if nf_loss is not None else Q_logprob
        #else:
