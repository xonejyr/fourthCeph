...
trainer_module = importlib.import_module(f"{MODULE_NAME}.trainer_only_subpixel")
utils_module = importlib.import_module(f"{MODULE_NAME}.utils")
builder_module = importlib.import_module(f"{MODULE_NAME}.builder")
transforms = importlib.import_module(f"{MODULE_NAME}.datasets.transforms")
...
get_coord = transforms.get_coord
